...
<?php
    ...
    if(isset($_GET['id'])){
	 ...
	 $getRoom = $conn->query("SELECT * FROM room WHERE hotel_id='$id'");
	 $getRoom->execute();

	 $getAllRooms = $getAllRoom->fetchAll(PDO::FETCH_OBJ);
    }   else{
...
?>
    ...
    <sectio class="ftco-section bg-light ftco-no-pt ftco-no-pb">
